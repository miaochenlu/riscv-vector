...
trait VLsuBehavior_st {
  ...
  def vLsuTest0(): Unit =
    it should "pass: unit-stride store (uops=1, eew=8, vl=8, vstart=0)" in {
      test(new SmartVectorLsuTestWrapper(false)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val stReqs = Seq(
          (
            vse8.copy(vl = 8, uopIdx = 0, uopEnd = true, isLoad = false, destVRegStart = true, destVRegEnd = true),
            stReqSrc_default,
          )
        )
  ...
  def vLsuTest1(): Unit =
    it should "pass: unit-stride store (uops=2, eew=8, vl=19, vstart=0)" in {
      test(new SmartVectorLsuTestWrapper(false)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val stReqs = Seq(
          (
            vse8.copy(vl = 19, uopIdx = 0, uopEnd = false, isLoad = false, destVRegStart = true, destVRegEnd = true),
            stReqSrc_default,
          ),
          (
            vse8.copy(vl = 19, uopIdx = 1, uopEnd = true, isLoad = false, destVRegStart = true, destVRegEnd = true),
            stReqSrc_default,
          ),
        )
  ...
  def vLsuTest2(): Unit =
    it should "pass: unit-stride store (uops=4, eew=16, vl=27, vstart=0)" in {
      test(new SmartVectorLsuTestWrapper(false)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val stReqs = Seq(
          (
            vse16.copy(vl = 27, uopIdx = 0, uopEnd = false, isLoad = false, destVRegStart = true, destVRegEnd = true),
            stReqSrc_default,
          ),
          (
            vse16.copy(vl = 27, uopIdx = 1, uopEnd = false, isLoad = false, destVRegStart = true, destVRegEnd = true),
            SrcBundleSt(vs3 = "hfedcba98765432100f0f0f0f0f0f0f0f"),
          ),
          (
            vse16.copy(vl = 27, uopIdx = 2, uopEnd = false, isLoad = false, destVRegStart = true, destVRegEnd = true),
            SrcBundleSt(vs3 = "h01010101010101011234567890123456"),
          ),
          (
            vse16.copy(vl = 27, uopIdx = 3, uopEnd = true, isLoad = false, destVRegStart = true, destVRegEnd = true),
            SrcBundleSt(vs3 = "h201f1e1d1c1b1a191817678901234567"),
          ),
        )
  ...
  def vLsuTest3(): Unit =
    it should "pass: unit-stride store (uops=3, eew=32, vl=10, vstart=0)" in {
      test(new SmartVectorLsuTestWrapper(false)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val stReqs = Seq(
          (
            vse32.copy(vl = 10, uopIdx = 0, uopEnd = false, isLoad = false, destVRegStart = true, destVRegEnd = true),
            stReqSrc_default,
          ),
          (
            vse32.copy(vl = 10, uopIdx = 1, uopEnd = false, isLoad = false, destVRegStart = true, destVRegEnd = true),
            SrcBundleSt(vs3 = "hfedcba98765432100f0f0f0f0f0f0f0f"),
          ),
          (
            vse32.copy(vl = 10, uopIdx = 2, uopEnd = true, isLoad = false, destVRegStart = true, destVRegEnd = true),
            SrcBundleSt(vs3 = "h01010101010101011234567890123456"),
          ),
        )
  ...
  def vLsuTest4(): Unit =
    it should "pass: unit-stride store (uops=2, eew=64, vl=3, vstart=0)" in {
      test(new SmartVectorLsuTestWrapper(false)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val stReqs = Seq(
          (
            vse64.copy(vl = 3, uopIdx = 0, uopEnd = false, isLoad = false, destVRegStart = true, destVRegEnd = true),
            stReqSrc_default,
          ),
          (
            vse64.copy(vl = 3, uopIdx = 1, uopEnd = true, isLoad = false, destVRegStart = true, destVRegEnd = true),
            SrcBundleSt(vs3 = "hfedcba98765432100f0f0f0f0f0f0f0f"),
          ),
        )
  ...
  def vLsuTest6(): Unit =
    it should "pass: unit-stride mask store (uops=1, eew=8, vl=8, vstart=0)" in {
      test(new SmartVectorLsuTestWrapper(false)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val stReqs = Seq(
          (
            vsm.copy(vl = 27, uopIdx = 0, uopEnd = true, isLoad = false, destVRegStart = true, destVRegEnd = true),
            stReqSrc_default,
          )
        )
  ...
  def vLsuTest7(): Unit =
    it should "pass: strided store (uops=1, eew=8, vl=6, vstart=0, stride=-5)" in {
      test(new SmartVectorLsuTestWrapper(false)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val stReqs = Seq(
          (
            vsse8.copy(vl = 6, uopIdx = 0, uopEnd = true, isLoad = false, destVRegStart = true, destVRegEnd = true),
            SrcBundleSt(scalar_opnd_2 = "hffffffff_fffffffb"),
          )
        )
  ...
  def vLsuTest8(): Unit =
    // fix eew=32
    it should "pass: strided store (uops=2, eew=32, vl=2, vstart=0, stride=-1)" in {
      test(new SmartVectorLsuTestWrapper(false)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        dut.clock.setTimeout(1000)
        dut.clock.step(1)
        val stReqs = Seq(
          (
            vsse32.copy(vl = 2, uopIdx = 0, uopEnd = true, isLoad = false, destVRegStart = true, destVRegEnd = true),
            SrcBundleSt(scalar_opnd_2 = "hffffffff_ffffffff"),
          )
        )
  ...
  def vLsuTest9(): Unit =
    it should "pass: strided store (uops=2, eew=16, vl=10, vstart=0, stride=4)" in {
      test(new SmartVectorLsuTestWrapper(false)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val stReqs = Seq(
          (
            vsse16.copy(vl = 10, uopIdx = 0, uopEnd = false, isLoad = false, destVRegStart = true, destVRegEnd = true),
            SrcBundleSt(scalar_opnd_2 = "h8"),
          ),
          (
            vsse16.copy(vl = 10, uopIdx = 1, uopEnd = true, isLoad = false, destVRegStart = true, destVRegEnd = true),
            SrcBundleSt(scalar_opnd_2 = "h8"),
          ),
        )
      ...
      test(new SmartVectorLsuTestWrapper(false)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val stReqs = Seq(
          (
            ...
            SrcBundleSt(scalar_opnd_2 = "h8", mask = "hffff_ffff_ffff_ffff_ffff_ffff_ffff_fefe"),
          ),
          (
            vsse16.copy(
              vm = false,
    ...
    it should "pass: unit-stride store exception" in {
      test(new SmartVectorLsuTestWrapper(false)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val stReqs = Seq(
          (
            vse8.copy(vl = 19, uopIdx = 0, uopEnd = false, isLoad = false, destVRegStart = true, destVRegEnd = true),
            SrcBundleSt(scalar_opnd_1 = "h1058"),
          )
        )
  ...
  def vLsuTest12(): Unit =
    it should "pass: unit-stride whole register store (uops=2, eew=8, vl=19)" in {
      test(new SmartVectorLsuTestWrapper(false)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        ...
        val stReqs = Seq(
          (
            vs2r.copy(vl = 19, uopIdx = 0, uopEnd = false, isLoad = false, destVRegStart = true, destVRegEnd = true),
            stReqSrc_default,
          ),
          (
            vs2r.copy(vl = 19, uopIdx = 1, uopEnd = true, isLoad = false, destVRegStart = true, destVRegEnd = true),
            SrcBundleSt(vs3 = "hfedcba98765432100f0f0f0f0f0f0f0f"),
          ),
        )
  ...
  def vLsuTest13(): Unit =
    it should "pass: strided store (uops=2, eew=16, vl=10, vstart=0, stride=0)" in {
      test(new SmartVectorLsuTestWrapper(false)).withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
        dut.clock.setTimeout(1000)
        dut.clock.step(1)
        val stReqs = Seq(
        ...
        dut.io.memInfo(index1000).expect("h0123456789ab1413".U)
      }
    }
}
